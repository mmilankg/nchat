...
enum MessageType {
    ...
    mEstablishedContact,     // send the client-distributed process a contact
    mSentContactRequest,     // send the client-distributed process a contact
    mReceivedContactRequest, // send the client-distributed process a contact
